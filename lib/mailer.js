...
//
// ⚠️ Brevo 发件人（2026-08-31 21:12 hr_support 验证成功后的最终口径）：
//   - HR_Support@insightelectionhk.com 已在 Brevo 后台完成邮箱验证（active=true，
//     当晚验证码 904422 通过 UI 完成），是正式发件人。
//   - 之前的 spfError 只影响后台红字提示，不阻断验证流程。
//   - hkinsight.hr@gmail.com（Brevo 账号邮箱）保留为应急备用发件人——
//     如日后 HR_Support 出问题，设 Render 环境变量 BREVO_SENDER=hkinsight.hr@gmail.com 即可切换。
//   - Reply-To 仍指向 HR_Support，候选人点回复进企微公共邮箱。
...
// Brevo 通道发件人：默认用已验证的公司邮箱 HR_Support（2026-08-31 21:12 起）
const BREVO_SENDER = process.env.BREVO_SENDER || 'HR_Support@insightelectionhk.com';
